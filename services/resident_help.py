...
def _build_ai_answer(
    ...
    system_instruction = (
        ...
        '5. Si te piden un GRÁFICO (ya sea de tendencia, distribución, meses, etc), DEBES usar EXCLUSIVAMENTE un gráfico tipo "pie" de Mermaid.\n'
        '   - NUNCA uses xychart-beta ni bar. Usa solo "pie".\n'
        '   - REGLA CRÍTICA: NUNCA uses comas en los números dentro del código Mermaid (usa 1500.50, NUNCA 1,500.50). Las comas rompen el gráfico.\n'
        '   - EJEMPLO ESTRICTO:\n'
        '     ```mermaid\n'
        '     pie title "Gastos por Mes"\n'
        '       "Enero" : 100.50\n'
        '       "Febrero" : 2000\n'
        '       "Marzo" : 3500.75\n'
        '     ```\n'
